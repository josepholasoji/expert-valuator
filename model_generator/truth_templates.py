...
{
  name: "MIT - Project: Model generator template table",
  templates:[
        {

            language: ["java", "javascript", "none"],
            technology: ["redis", "monogodb", "mssql", "spring", "spring-boot", "apache-camel","nodejs", "angulajs","reactjs","unknown"]
            disqualified:{
               language: "none",
               library: "none",
